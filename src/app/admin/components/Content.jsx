...
function Content({ totalUsersData, totalPostsData }) {
  return (
    <div className='px-10 rounded-lg'>
        ...
        <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita fugiat ullam possimus iste ipsum incidunt molestias ipsam architecto, facilis quia. Expedita adipisci illum veniam, quisquam mollitia dolore? Quod, recusandae magnam?
        </p>
    </div>
  )
}
