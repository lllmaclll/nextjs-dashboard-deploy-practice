            ...
            <div className='flex-grow'>
                <div className='container mx-auto shadow-xl my-10 p-10 rounded-xl'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <input type="text" className='w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2' placeholder={userOldData?.password} onChange={(e) => setNewPassword(e.target.value)} value={newPassword} />
